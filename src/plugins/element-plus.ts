...
import(`@/style/element-ui/element-ui-base-${elStyleType}.scss`) // 引入element-ui样式表----------每次重置样式表都需要刷新页面才可以正常展示
// require(`@/style/element-ui/element-ui-variable-${elThemeType}.scss`); // 导入修改过的主题文件
import(`@/style/element-ui/element-ui-variable-${elThemeType}.scss`); // 导入修改过的主题文件
