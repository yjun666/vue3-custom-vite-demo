<template>
  ...
  <div>
    ...
    <div>
      formatDate(new Date(), "y-M-d h:m:s t")==={{
        formatDate(new Date(), "y-M-d h:m:s t")
      }}
    </div>
  </div>
...
console.log(
  "import.meta.env.VITE_CUSTOM_TEST===" + import.meta.env.VITE_CUSTOM_TEST
);
console.log("import.meta.env.MODE===" + import.meta.env.MODE);
console.log(
  "instance.appContext.config.globalProperties.$utils.uuid()===" + uuid()
);
console.log(
  "instance.appContext.config.globalProperties.$utils.formatDate()===" +
    formatDate(new Date(), "y-M-d h:m:s t")
);
